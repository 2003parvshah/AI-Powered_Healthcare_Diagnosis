...
HF_MODEL_REPO = "dhrupal8300/fine_tuned_pubmedbert"
HF_ACCESS_TOKEN = "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"

# Load model and tokenizer
text_model = AutoModelForSequenceClassification.from_pretrained(HF_MODEL_REPO, use_auth_token=HF_ACCESS_TOKEN)
text_tokenizer = AutoTokenizer.from_pretrained(HF_MODEL_REPO, use_auth_token=HF_ACCESS_TOKEN)
