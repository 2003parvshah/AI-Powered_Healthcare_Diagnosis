...
class Health_issueSeeder extends Seeder
{
    public function run()
    {
        DB::table('health_issues')->insert([
            [
                'patient_id' => 1,
                'symptom_description' => 'Fever, headache, and fatigue',
                'report_pdf' => 'reports/report_1.pdf',
                'report_image' => 'reports/report_1.jpg',
                'doctor_type' => 'General Physician',
                'diagnosis' => 'Viral Fever',
                'solution_description' => 'Rest, hydration, and paracetamol for fever.',
                'other_info' => 'Follow up in 3 days if symptom_description persist.',
            ...
            [
                ...
                'solution_description' => 'Prescribed aspirin and lifestyle modifications.',
            ...
            [
                'patient_id' => 2,
                'symptom_description' => 'Severe lower back pain',
                'report_pdf' => 'reports/report_3.pdf',
                'report_image' => 'reports/report_3.jpg',
                'doctor_type' => 'Orthopedic',
                'diagnosis' => 'Lumbar Strain',
                'solution_description' => 'Physical therapy and pain relief medication.',
