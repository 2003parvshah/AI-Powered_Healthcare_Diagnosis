...
const DoctorAvailableTimee = ({
  ...
  return (
    <div>
      ...
      <div className="grid min-w-md grid-cols-4 gap-3">
        {timeSlots.length !== 0 ? (
          timeSlots.map((slot, index) => (
            <Button
              ...
              className={cn(
                "flex h-12 flex-col rounded-md border p-4 transition",
                slot.available
...
export default DoctorAvailableTimee;
